const textConfig = {
  text1: "Hi Thầy Chu!",
  text2: "Em có cái này tặng anh, anh muốn xem không?",
  text3: "Nếu giờ cho anh thêm cơ hội quay xe,",
  text4: "Anh có quay không?",
  text5: "Quay liền, quay gấp",
  text6: "Em điên quá",
...
$(document).ready(function () {
  ...
  $("#yes").click(function () {
    ...
    Swal.fire({
      ...
      width: 900,
      padding: "3em",
      html: "<input type='text' class='form-control' id='txtReason'  placeholder='Nói em nghe anh thích gì nè?'>",
      background: '#fff url("img/iput-bg.jpg")',
      backdrop: `
                    rgba(0,0,123,0.4)
                    url("img/giphy2.gif")
      ...
      if (result.value) {
        Swal.fire({
          ...
          onClose: () => {
            window.location = "https://www.facebook.com/tram.phan.399/";
          },
        });
      }
    });
